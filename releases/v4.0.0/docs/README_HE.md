...
**הודעה חשובה: פרויקט זה למטרות חינוכיות בלבד**

- 📚 **מטרה חינוכית** - הדגמת תקשורת P2P והצפנה
- ⚖️ **ציית לחוק** - משתמשים חייבים לציית לחוקים המקומיים
- 🚫 **אין שימוש לא חוקי** - אסור לפעילויות לא חוקיות
- 📝 **אחריות המשתמש** - משתמשים נושאים באחריות משפטית
- 🔒 **נייטרליות טכנולוגית** - הטכנולוגיה נייטרלית

**בשימושך בפרויקט זה, אתה מסכים:**
1. להשתמש רק למטרות חוקיות
2. לא לעסוק בפעילויות לא חוקיות
3. לקבל סיכונים טכניים
4. לציית ל[תנאים](TERMS_OF_SERVICE.md) ו[לפרטיות](PRIVACY.md)

ראה: [הודעת אבטחה](SECURITY_NOTICE.md)
