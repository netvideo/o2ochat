...
**중요 공지: 이 프로젝트는 교육 목적으로만 제공됩니다**

- 📚 **교육 목적** - P2P 통신, 종단 간 암호화 기술 데모
- ⚖️ **법률 준수** - 현지 법률을 준수해야 합니다
- 🚫 **불법 사용 금지** - 불법 활동에 사용하지 마세요
- 📝 **사용자 책임** - 사용자는 법적 책임을 집니다
- 🔒 **기술적 중립성** - 기술 자체는 중립적입니다

**이 프로젝트를 사용하면 동의합니다:**
1. 합법적인 목적으로만 사용
2. 불법 활동에 참여하지 않음
3. 기술적 위험 수용
4. [이용약관](TERMS_OF_SERVICE.md) 및 [개인정보처리방침](PRIVACY.md) 준수

자세히: [보안 알림](SECURITY_NOTICE.md)
